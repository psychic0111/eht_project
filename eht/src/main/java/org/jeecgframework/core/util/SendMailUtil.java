...
public class SendMailUtil
{
  ...
  private static String from = "public_z@163.com";
  private static  String fromName = "管理员";
  private static  String charSet = "utf-8";
  private static  String username = "public_z@163.com";
  private static  String password = "19772362";
  public static String   subject="测试标题无账号";
  public static String  content="测试内容无账号";
	...
	public static void sendFtlMail(String toMailAddr, String subject,
			String templatePath, Map<String, Object> map)throws Exception{
	 ...
	 * @param map 模板map
	 */
	public static void sendFtlMail(List<String> toMailAddr, String subject,
			String templatePath, Map<String, Object> map)throws Exception{
	  Template template = null;
	  Configuration freeMarkerConfig = null;
	  HtmlEmail hemail = new HtmlEmail();
	 ...
	 * @param message 发送email信息  
	 */
	public static void sendCommonMail(String[] toMailAddr, String subject, String message) throws Exception{
		  HtmlEmail hemail = new HtmlEmail();
		try {
			hemail.setHostName(getHost(from));
			hemail.setSmtpPort(getSmtpPort(from));
