...
(function () {
    ...
    var IMG_URL = window.UEDITOR_IMG_URL || "";
    /**
    ...
    window.UEDITOR_CONFIG = {
       ...
       // ,savePath: [ 'UEditor/upload1','UEditor/upload2','UEditor/upload3']    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        , toolbars:[
            /*['source', 'undo', 'redo', '|','bold', 'italic', 'underline','fontborder', 'strikethrough',  'pasteplain', '|',
...
//        }
        ...
        ,initialFrameWidth:635  //初始化编辑器宽度,默认1000
