...
Dialog.prototype = {
	...
	getOptions : function( arg ){
		var i,
			...
			defaults = {
				...
				width:    null,			// function          关闭弹出层后执行的回调函数
				height:    null			// function          关闭弹出层后执行的回调函数
				/** 
	...
	createDialogBox : function(){
		...
		dialogBox.style.cssText = 'margin:0;padding:0;width:540px;border:none;z-index:2000;';
	...
	createDialogWrap : function( tmpl ){
		...
		var header = tmpl.header ? 
			'<h5 class="easyDialog_title" id="easyDialogTitle"><a href="javascript:void(0)" title="关闭窗口" class="close_btn" id="closeBtn">&times;</a>' + tmpl.header + '</h5>' :
			'',
			// 确定按钮
