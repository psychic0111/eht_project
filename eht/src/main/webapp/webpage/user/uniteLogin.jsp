  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td valign="top" class="mainer_right"><div class="right_top">
          <div class="Nav"></div>
          <div class="CurTitle" style="padding-left:50px;">联合登陆</div>
        </div>
        <!-- Begin mainer_index-->
            	...
            	<input type="hidden" name="id" value="<%=request.getParameter("id")%>"/> 
	              <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
	                ...
	                <tr>
	                  <td>手机：</td>
	                  <td>
	                  	<input class="InputTxt2" style=" width:40%; height:28px; " type="text" name="mobile" id="mobile" datatype="m" value="${SESSION_USER_ATTRIBUTE.mobile }" />
	                  </td>
	                </tr>
	                <tr>
	                  <td>头像：</td>
	                  <td>
						  ...
						  <input class="InputTxt2" id="file" value="default.img"  name="file" type="file" />
	                  </td>
	                </tr>
	                <tr>
	                  <td>&nbsp;</td>
	                  <td>
	                  	...
	                  	<input class="Button1" type="button" onclick="javascript:window.location.href='${webRoot}/indexController/front/index.dht'" value="返回"  />
