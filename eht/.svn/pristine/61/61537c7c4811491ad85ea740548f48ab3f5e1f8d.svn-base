...
<div style="width:100%;height:auto;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
    ...
    <div> 
	<form name="blackListDirectoryForm" id="blackListDirectoryForm" method="post" > 
		<input type="hidden" value="${subjectId}" name="subjectId" >
		<input type="hidden" value="${directoryId}" name="directoryId" >
          <!-- End function--> 
          <!-- Begin comments-->
          <div>
                	...
                	<tr class="TD1">
                    	...
                    	<td width="20%" align="center">
	                  		<span class="others">
	                  		     ...
	                  		     <input type="button" value="移除黑名单" id="3" name="del_btn" onclick="addBlackListDirectory('${RoleUser.accountEntity.id}','${directoryId}',this)" class="Button_other1">
	                  		     </c:if>
	                  		    <c:if test="${RoleUser.blackList eq false}">
	                  		    <input type="button" value="加入黑名单" id="3" name="del_btn" onclick="addBlackListDirectory('${RoleUser.accountEntity.id}','${directoryId}',this)" class="Button_other1">
	                  		     </c:if>
	                   		</span>
	              		</td>
                	</tr>
          ...
          <div class="pages" style="width:525px;">
          	<xd:pager  pagerFunction="doPageblackDirectoryList" pagerStyle="cursor:pointer"  curPagerTheme="pages_cur" showTextPager="true"></xd:pager>
